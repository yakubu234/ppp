  ...
  var morris_chart = {
    init: function () {
      Morris.Area({
        ...
        ykeys: ["y", "z"],
        labels: ["Y", "Z"],
        lineColors: [dunzoAdminConfig.secondary, dunzoAdminConfig.primary],
      }),
        Morris.Line({
          ...
          xkey: "y",
          ykeys: ["a", "b"],
          lineColors: [dunzoAdminConfig.primary, dunzoAdminConfig.secondary],
        ...
        Morris.Bar({
          ...
          ykeys: ["y"],
          labels: ["Y"],
          barColors: [dunzoAdminConfig.primary],
        }),
        $(function () {
          var b = [
            {
          ...
          Morris.Bar({
            ...
            data: b,
            barColors: [dunzoAdminConfig.primary, dunzoAdminConfig.secondary],
            xkey: "period",
        ...
        $(function () {
          ...
          window.m = Morris.Line({
            ...
            labels: ["sin(x)"],
            parseTime: !1,
            lineColors: [dunzoAdminConfig.primary],
