...
<link rel="stylesheet" type="text/css" href="../../assets/css/vendors/flatpickr/flatpickr.min.css">
                  ...
                  <div class="card-body basic-wizard important-validation">
                    ...
                    <div id="msform">
                      ...
                      <input class="form-control" id="email-basic-wizard" name="email" value="<?php echo $currentUser['email']; ?>" type="hidden" required="" placeholder="dunzo@gmail.com">
                       <input class="form-control" id="firstnamewizarnwd" name="fullname" value="<?php echo $currentUser['fullname']?>" type="hidden" required="" placeholder="Enter your name">

                        <input type="hidden" value="update_new_booking" name="form_action"  />
                        <div class="col-sm-6">
                          <label class="form-label" for="email-basic-wizard-email">Customer Email<span class="txt-danger">*</span></label>
                          <input class="form-control" id="email-basic-wizard-email" name="customer_email"  type="email" required="" placeholder="customer email">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="firstnamewizardfullname">Customer Fullame<span class="txt-danger">*</span></label>
                          <input class="form-control" id="firstnamewizardfullname" name="customer_fullname" type="text" required="" placeholder="Enter customer name">
                        </div>
                         <div class="col-sm-6">
                          <label class="form-label" for="customerPhone">Customer Phone<span class="txt-danger">*</span></label>
                          <input class="form-control" id="customerPhone" name="customer_phone"  type="text" required="" placeholder="Enter customer phone ">
                        </div>
                         <div class="col-sm-6">
                          <label class="form-label" for="customerAddress">Customer Address<span class="txt-danger">*</span></label>
                          <input class="form-control" id="customerAddress" name="customer_address"  type="text" required="" placeholder="Enter Customer Address ">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="contactperson_name">Customer Contact person Fullame<span class="txt-danger">*</span></label>
                          <input class="form-control" id="contactperson_name" name="customer_contact_person_fullname" type="text" required="" placeholder="Enter customer name">
                        </div>
                         <div class="col-sm-6">
                          <label class="form-label" for="contactperson_phone">Customer Contact person Phone<span class="txt-danger">*</span></label>
                          <input class="form-control" id="contactperson_phone" name="customer_contact_person_phone"  type="text" required="" placeholder="Enter customer phone ">
                        </div>
 ...
 -->
                      <!--   <div class="col-sm-6">
                        ...
                        <div class="col-sm-6"> 
                        <label class="form-label" for="type_of_event">Select Type  of Event<span class="txt-danger">*</span></label>
                                  <select class="form-select" name="type_of_event" id="type_of_event" required="" aria-label="select example">
                        ...
                        <div class="col-sm-6">
                          <label class="form-label" for="number_of_guest">Number of guests<span class="txt-danger">*</span></label>
                          <input class="form-control" id="number_of_guest" name="number_of_guest" type="text" required="" placeholder="Enter number of guest">
                        </div>
                        ...
                        <div class="col-xl-6">
                          <div class="card">
                            <div class="card-header pb-0">
                            <label class="form-label" for="from_date">From Date<span class="txt-danger">*</span></label>
                            </div>
                        ...
                        <div class="col-xl-6">
                          <div class="row" >
                            <div class="col-sm-12" >
                              <div class="card">
                            <div class="card-header pb-0">
                            <label class="form-label" for="time_start">Start Time<span class="txt-danger">*</span></label>
                            </div>
                            <div class="card-body card-wrapper"> 
                              <div class="row g-3">
                                <div class="col-12">
                                  <div class="input-group ">
                                    <input class="form-control mb-2" id="time_start"  name="time_start" type="time">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row" >
                            <div class="col-sm-12" >
                              <div class="card">
                            <div class="card-header pb-0">
                            <label class="form-label" for="time_end">End Time<span class="txt-danger">*</span></label>
                            </div>
                            <div class="card-body card-wrapper"> 
                              <div class="row g-3">
                                <div class="col-12">
                                  <div class="input-group ">
                                    <input class="form-control mb-2" id="time_end" name="time_end" type="time">
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <form class="stepper-two row g-3 needs-validation custom-input" novalidate="">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="mb-3">
                            <label class="form-label text-success" for="select_services">Choose Services from the list below </label>
                            <select class="form-select input-air-primary digits" required  id="select_services"  onchange="addToCart()">
                        ...
                        <div class="col-sm-12">
                          <label class="form-label" for="optional_message">Leave a message(optional)<span class="txt-danger"></span></label>
                          <textarea class="form-control" name="message" id="optional_message" rows="3"></textarea>
                        </div>
    ...
    <script>
      ...
      function getTimeValue(timeString) {
        // Split the string by whitespace (if any)
        const parts = timeString.split(/\s+/);
        
        // Extract the time part (first element)
        const time = parts[0];
      ...
      function mountDataFromDb(db_records){
        ...
        document.getElementById('customerPhone').value = db_records.customer_phone
        document.getElementById('customerAddress').value = db_records.customer_address
        document.getElementById('contactperson_name').value = db_records.customer_contact_person_fullname
        document.getElementById('contactperson_phone').value = db_records.customer_contact_person_phone
        document.getElementById('number_of_guest').value = db_records.number_of_guest

        // Custom-flatpickr JS
                //

        calendar(convertDate(db_records.from));
        // document.getElementById('inline-calender').value = convertDate(db_records.from)
        ...
        var selectElement = document.getElementById('type_of_event');

        const matchingOption = selectElement.querySelector(`option[value="${db_records.type_of_event}"]`);
      ...
      window.setTimeout(function() {
            ...
            mountDataFromDb(db_records);
        // Your code to be executed after 2 milliseconds
        console.log("This code runs after 2 milliseconds!");
      }, 100);
      //call the moutn data to populate db records.
  ...
  //       };
      ...
      function submitFormData() {
        ...
        fetch('../../handler/new.booking.edit.php', {
          method: 'POST',
          body: formData
        })
        .then(response => {
