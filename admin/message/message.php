                                ...
                                $messageStatus =' <span class="badge rounded-pill badge-success">New</span>'; 
                                 ...
                                 echo' <td>'.$messageStatus.'</td>
                                  ...
                                  <ul class="action">
                                      ...
                                      <li class="edit"><a title="Delete" href="../../handler/message.delete.php?id='.$message['id'].'"><button class="btn btn-danger"><i class="icofont icofont-trash" style="color: white;"></i></button> </a></li>':"";
