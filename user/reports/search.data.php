  ...
  <?php include('../../includes/nav.php'); ?>
                  ...
                  <div class="card-header">
                    <form class="theme-form">
                      <div class="input-group m-0 flex-nowrap">
                        ...
                        <span class="btn btn-primary input-group-text" onclick="searchBookings()">Search</span>
                      </div>
                    </form>
                  </div>
                  <div class="card-body">
    ...
    <script>
              function searchBookings(data) {
                ...
                let search_field_2 = document.getElementById('search_field_2').value;

                let search_key = 'start_date';
                let search_key_2 = 'end_date';
                    let forPost = new FormData();
                    forPost.append(search_key, search_field);
                    forPost.append(search_key_2, search_field_2);

                    fetch('../../handler/report.php', {
                    method: 'POST',
                    body: forPost
                    })
                    .then(response => {
