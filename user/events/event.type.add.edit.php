...
if(isset($_GET['id'])){
    ...
    $eventType = $query->fetch(PDO::FETCH_ASSOC);
}
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="card-wrapper border rounded-3">
                      <form class="row g-3" method="POST" action="../../handler/eventType.add.edit.php">
                        <input type="hidden" value="<?php echo isset($eventType['id'])? $eventType['id']:""; ?>" name="item_id" />
                        <div class="col-md-12">
                          <label class="form-label" for="inputEmail4">Name</label>
                          <input class="form-control" required id="inputEmail4" value="<?php echo isset($eventType['name'])? $eventType['name']:""; ?>"  required name="name" type="text" placeholder="Enter Service Name">
                        </div>
                        <div class="col-md-12">
                          <div class="mb-3">
                            ...
                            <select class="form-control" id="exampleFormControlSelect7" required name="status">
                                <?php if(isset($eventType['status'])){
                                    echo '
                                    <option value="'.$eventType['status'].'" selected readonly>'.$eventType['status'].'</option>';
                                }else{
                                    echo '
